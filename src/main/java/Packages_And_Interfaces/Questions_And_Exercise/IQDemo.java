package Packages_And_Interfaces.Questions_And_Exercise;

import Packages_And_Interfaces.Questions_And_Exercise.qpack.*;

//  Демонстрация трёх реализаций интерфейса ICharQ
public class IQDemo {
